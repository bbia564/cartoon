...
import 'package:cartoon_sale/app/tools/permission_util.dart';
...
Widget pmDivider() {
  return Divider(
    color: PMColorUitl.pmGetColor("#EBEBEB"),
    height: 1,
    thickness: 0,
    indent: 0,
    endIndent: 0,
...
Future<XFile?> csPickSingleImageXFile() async {
  bool status = false;
...
csShowDatePicker(String title, Function(DateTime chooseDateTime) saveAction,
            ...
            children: [
              IconButton(
                  ...
                  icon: Icon(
                    ...
                    color: PMColorUitl.pmGetColor("#AAAAAA"),
                  )),
              pmGetText(title, fontWeight: FontWeight.w400),
              TextButton(
                  onPressed: () {
                    saveAction(chooseDate);
                    Get.back();
                  },
                  child: pmGetText("Save", textColor: PMColorUitl.pmGetColor("#AAAAAA")))
            ],
          ),
        ),
        pmDivider(),
